...
import { signup, login, updateProfile, changePassword } from '../controllers/authController.js'
import { adminLogin } from '../controllers/adminAuthController.js'
import {
  getCelebs, getCeleb,
  adminGetCelebs, adminGetCeleb, createCeleb, updateCeleb, deleteCeleb,
} from '../controllers/celebController.js'
import {
  createBooking, getMyBookings,
  adminGetBookings, updateBookingStatus,
} from '../controllers/bookingController.js'
import {
  getDashboard,
  getUsers, updateUserStatus, updateUserMembership,
  getSettings, updatePlatformSettings, updateNotificationSettings,
  updatePricing, updateSuperKey,
...
router.put('/admin/celebs/:id',       adminProtect, upload.single('image'), updateCeleb)
...
router.put('/admin/settings/notifications',  adminProtect, updateNotificationSettings)
